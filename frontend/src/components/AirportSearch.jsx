...
function FlightSearch() {
  ...
  useEffect(() => {
    fetch("https://main-rebecca-alessandrocoretti-99c3ef12.koyeb.app/api/airports")
  ...
  const searchFlightsAndHotels = async () => {
    ...
    try {
      ...
      const autoCompleteUrl = `https://main-rebecca-alessandrocoretti-99c3ef12.koyeb.app/api/hotels/auto-complete?query=${toIata}`;
      ...
      if (data.data && data.data.length > 0) {
        ...
        // Ricerca voli
        const flightUrl = `https://main-rebecca-alessandrocoretti-99c3ef12.koyeb.app/api/flights/search?from=${fromIata}&to=${toIata}&departureDate=${departureDate}${
